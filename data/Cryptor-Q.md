...
[L04] adding shares can cause overflow 

Adding inflation to shares can potentially cause an overflow 



[L05] Pointless check on check.min.bond
...
[L06] 2 functions with same name can be confusing 
...
[L07] No ensure origin in the IncentivesManager imple
...
[L08] Available balance can be misleading due to not counting min deposit 
...
[L09] OnloanUpdate can break accounting between bonded tokens and shares
